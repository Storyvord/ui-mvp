...
type HeaderProps = {
  list: boolean;
  submittedData: CreateResourceType[];
  handleDelete: () => void
};
      ...
      <>
        {list ? (
          <div className="flex flex-wrap gap-4">
            {submittedData.length > 0 ? (
              submittedData.map((item: any) => (
                <div key={item.id} className="bg-white w-[370px] h-[150px] shadow-md p-4 rounded-md flex flex-col">
                  <div onClick={handleClickModal} className="flex items-end justify-end cursor-pointer relative">
                    <CiMenuKebab size={18} />
                    <div className="absolute top-0 right-4">
                      {isModalShow && (
                        <div className="bg-white p-2 w-[190px] border shadow-xl rounded-md flex flex-col gap-2">
                          ...
                          <div onClick={handleDelete} className="flex items-center hover:bg-red-50 px-2 py-2 rounded-md text-red-600 gap-3">
          ...
          <div className="flex flex-col gap-3 mt-2">
            {submittedData.length > 0 ? (
              submittedData.map((item: any) => (
                <div key={item.id} className="bg-white w-full h-[60px] border shadow-sm rounded-md flex items-center">
