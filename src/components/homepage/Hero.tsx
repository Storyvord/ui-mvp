...
const Hero = () => {
    return (
        <div className="relative flex flex-row items-center justify-between h-[640px] max-w-full bg-cover bg-center" style={{ backgroundImage: "url('https://storyvord.com/img/banner-bg.png')" }}>
            <div className="relative text-left flex-col p-0 px-3 lg:py-4 py-1 lg:ml-24 lg:w-1/2 lg:top-[-40px] top-[-95px] text-white">
                ...
                <div className="lg:mt-[-30px] w-full lg:w-80 lg:ml-10">
                    <div className="lg:h-48 lg:w-64 h-24 w-full lg:ml-3 lg:mr-11">
                        <Link href={"/dashboard/home"}>
                            <div className="flex flex-row justify-between bg-gradient-to-r hover:bg-gradient-to-l from-[#03256c] to-green-500 py-4 relative top-10 w-full lg:w-96 lg:h-20 h-24">
