    ...
    <section className="">
      <div className='py-5 flex flex-row gap-2 -mb-2 mt-5'>
        ...
        <div className='flex flex-col -mt-2'>
          <span className='text-2xl font-medium'>Sent Call Sheets</span>
          <span className='text-slate-500 text-xs'>You can find copies of your call sheets here after sending them to your crew.</span>
        </div>
      </div>
      <div className='flex flex-col md:flex-row lg:flex-row items-center lg:justify-between md:justify-between'>
        <div className='flex'>
