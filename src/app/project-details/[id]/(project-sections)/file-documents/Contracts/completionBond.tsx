...
import { FolderOpen, X, Trash2, File, ShieldCheck } from 'lucide-react';
        ...
        <section className="">
            <div className='py-5 flex flex-row gap-2 -mb-2 mt-5'>
                ...
                <div className='flex flex-col -mt-2'>
                    <span className='text-2xl font-medium'>Completion Bond</span>
