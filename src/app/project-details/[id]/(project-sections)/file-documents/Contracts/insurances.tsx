...
import { FolderOpen, X, Trash2, File, Coins } from 'lucide-react';
...
const Insurance: FC = () => {
    ...
    const handlePreview = (file: File) => {
        if (isMobileOrMd) {
            ...
            // For devices between md and lg breakpoints, do not preview, show the download message
            setPreviewFile(file);
        } else {
            setPreviewFile(file);
        }
        ...
        <section className="">
            <div className='py-5 flex flex-row gap-2 -mb-2 mt-5'>
                ...
                <div className='flex flex-col -mt-2'>
                    <span className='text-2xl font-medium'>Insurances</span>
                    <span className='text-slate-500 text-xs'>
                        Here you can organize all contracts for insurances.
                    </span>
                </div>
            </div>
