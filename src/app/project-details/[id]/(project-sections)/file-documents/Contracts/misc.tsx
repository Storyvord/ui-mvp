...
import { FolderOpen, X, Trash2, File, BookUser } from 'lucide-react';
        ...
        <section className="">
            <div className='py-5 flex flex-row gap-2 -mb-2 mt-5'>
                ...
                <div className='flex flex-col -mt-2'>
                    <span className='text-2xl font-medium'>Miscellaneous Contracts</span>
                    <span className='text-slate-500 text-xs'>
                        Contracts for other miscellaneous purposes can be arranged here.
                    </span>
                </div>
            </div>
