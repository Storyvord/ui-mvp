...
import { FolderOpen, X, Trash2, File, MapPinned, Component } from 'lucide-react';
        ...
        <section className="">
            <div className='py-5 flex flex-row gap-2 -mb-2 mt-5'>
                ...
                <div className='flex flex-col -mt-2'>
                    <span className='text-2xl font-medium'>Production Design</span>
                    <span className='text-slate-500 text-xs'>
                        Each and every production design contract is available here.
                    </span>
                </div>
            </div>
