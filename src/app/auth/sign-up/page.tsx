        ...
        <div className="w-full px-5 py-4 lg:px-24 md:px-8 sm:px-8">
          ...
          <form className="mt-4" onSubmit={handleSubmit(onSubmit)}>
            <div className="">
              ...
              />
              {errors.email && (
                <p className="text-red-500 font-poppins text-sm">{errors.email.message}</p>
              )}
            </div>
            <div className="mt-3">
              ...
              {errors.password && (
                <p className="text-red-500 font-poppins text-sm">{errors.password.message}</p>
              )}
              <p className="text-sm font-normal text-[#666666] font-poppins mt-1">
