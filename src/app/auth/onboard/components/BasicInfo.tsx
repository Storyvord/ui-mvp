...
export default function BasicInfo({ prevStep, onSuccessStep }: BasicInfoProps) {
  ...
  const { mutateAsync: postPersonalDetails } = usePostPersonalDetails();
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="lg:px-96 md:px-4 mt-8 gap-x-16">
          <div className="w-full">
            ...
            />
            {errors.name && (
              <p className="text-red-500 font-poppins text-sm">{errors.name.message}</p>
            )}
          </div>
          ...
          <div className="w-full mt-5">
            <Label className="font-poppins font-normal text-[#666666] text-base">
              Personal Website <span className="text-xs">(Optional)</span>
            </Label>
            <Input
              type="text"
              {...register("website")}
          ...
          <div className="w-full mt-5">
            ...
            />
            {errors.about && (
              <p className="text-red-500 font-poppins text-sm">{errors.about.message}</p>
            )}
          </div>
          <div className="w-full mt-5">
            <Label className="font-poppins font-normal text-[#666666] text-base">
            ...
            {fileData ? (
              <div>
                <Image
                  ...
                  width={140}
                  height={140}
                  className="w-36 h-36 object-cover rounded-xl border-[#66666659] border-[1px]"
                  alt="Profile Photo"
                />
                <p
                  className="text-sm font-normal text-[#111111] font-poppins underline pt-1 cursor-pointer"
        ...
        <div className="flex justify-end mt-10 mb-10 gap-x-4">
          <Button className="w-44" type="submit" onClick={handleBack}>
            Back
          </Button>
          <Button className="w-44 font-poppins" type="submit" disabled={isLoading}>
